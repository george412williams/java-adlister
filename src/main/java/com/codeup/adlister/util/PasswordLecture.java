...
//        String hash = BCrypt.hashpw(password, BCrypt.gensalt());
            //happens on a registration, capture pw, hash it, save the hash result
...
//            //showing how hashing gets diff results
...
//        System.out.println("HASH4: " + hash4);
        ...
        // represents a user logging in, we would take the password and compare it to the hashed pw in the db
            //need to pay attn to how a user logs in, to check, capture on loginservlet, pass to bcrypt.checkpw...
            //qwerty to hash2, pulled from db, just need to call bcrypt and check against, T or F, here T
...
//
////        //Notice here we have changed the password that we're checking to check to admin
...
//        //NOTE: 3 sep instances of the same, not mult
...
//        System.out.println(hashedPw3);
        ...
        //to see how long these rounds can take, swap numbers out and watch the results
            //leave password3 uncomment, comment rest out and test this, see NOTES too
